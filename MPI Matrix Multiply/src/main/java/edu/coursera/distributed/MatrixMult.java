...
public class MatrixMult {
    ...
    public static void parallelMatrixMultiply(Matrix a, Matrix b, Matrix c,
        ...
        // Step 1:  what rank am i? and how many ranks are there?
        final int myrank = mpi.MPI_Comm_rank(mpi.MPI_COMM_WORLD);
        final int size = mpi.MPI_Comm_size(mpi.MPI_COMM_WORLD);

        // Step 2: calculate number of rows per rank, and which rows to calculate on this rank
        ...
        // Step 3: broadcast from rank 0 the matrix a and b (should really send only slice of matrix)
        ...
        // Step 4: calculate relevant rows of matrix c 
        ...
        // Step 5: receive all calculated c back on rank 0
        if (myrank == 0){
